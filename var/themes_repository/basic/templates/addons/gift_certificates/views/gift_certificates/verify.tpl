...
<div id="content_detailed" class="hidden">
    <h5 class="subheader">{__("gift_certificate_info")}</h5>
    <div class="info-field-body">
    <table class="gift-verify-table">
    <tr>
        <td style="width: 30%;"><strong>{__("gift_cert_code")}:</strong></td>
    ...
    <h5 class="subheader">{__("free_products")}</h5>
...
<div id="content_log" class="hidden">
    ...
    <table class="table gift-history table-width">
        <thead>
            <tr>
...
{else}
    <div class="gift-validate-error center strong">{__("error_gift_cert_code")}</div>
{/if}
