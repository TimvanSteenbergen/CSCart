<p>{__("text_ogonedirect_notice")}</p>
<hr>
...
<div class="control-group">
    <label class="control-label" for="userid">{__("user_id")}:</label>
    <div class="controls">
        <input type="text" name="payment_data[processor_params][userid]" id="userid" size="60" value="{$processor_params.userid}" >
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="password" name="payment_data[processor_params][password]" id="password" size="60" value="{$processor_params.password}" >
    </div>
</div>
