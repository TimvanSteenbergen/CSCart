<div id="DebugToolbarSubTabSQLParse">
    <form action="{""|fn_url}" method="post" class="cm-ajax">
        ...
        <table width="100%" height="50px">
           <tr>
                <td valign="top" width="100px">{include file="buttons/button.tpl" but_text="Send" but_id="DebugToolbarSubTabSQLParseSubmit" but_meta="btn-primary"}</td>
                <td valign="top">
        ...
        <table width="100%" class="deb-table">
            <tr>
