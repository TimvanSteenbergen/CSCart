{if $product.extra.buy_together}
    ...
    <tr class="valign-top {$_class}">
        <td class="valign-top">
            ...
            <p><a class="cm-combination combination-link" id="sw_conf_{$key}"><i class="icon-right-dir dir-list" title="{__("expand_sublist_of_items")}" id="on_conf_{$key}"></i><i class="icon-down-dir dir-list hidden" title="{__("collapse_sublist_of_items")}" id="off_conf_{$key}"></i>{__("buy_together")}</a></p>
            {/if}
        </td>
    ...
    <tr class="{$_class} hidden" id="conf_{$key}">
        ...
        <div class="box">
            ...
            <tr {cycle values=",class=\"table-row\"" name="gc_`$gift_key`"} style="vertical-align: top;">
                <td>
                ...
                <td class="center nowrap">
                    {include file="common/price.tpl" value=$product.price}</td>
                <td class="center nowrap">
                    {$product.amount}</td>
                {if $order_info.use_discount}
