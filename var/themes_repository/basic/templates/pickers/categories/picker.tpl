...
{if $view_mode != "list"}
    ...
    {if !$no_container}<div class="{if !$multiple}float-left{else}buttons-container picker{/if}">{/if}
        {if $multiple}
