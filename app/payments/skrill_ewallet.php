...
//		$pp_response['mb_currency'] = $mb_currency;
    ...
    $post_data = array(
        ...
        'return_url' => fn_url("payment_notification.return?payment=skrill_ewallet&order_id=$order_id$suffix", AREA, 'current'),
        'return_url_text' => '',
        'cancel_url' => fn_url("payment_notification.cancel?payment=skrill_ewallet&order_id=$order_id$suffix", AREA, 'current'),

        'status_url' => fn_url("payment_notification.status?payment=skrill_ewallet&order_id=$order_id$suffix", AREA, 'current'),
