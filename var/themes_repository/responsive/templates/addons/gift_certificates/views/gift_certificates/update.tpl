...
<div class="ty-control-group">
    ...
    <input type="text" id="gift_cert_recipient" name="gift_cert_data[recipient]" class="ty-input-text-full" size="50" maxlength="255" value="{$gift_cert_data.recipient}" />
</div>
...
<div id="gc_switcher">
    ...
    <div class="ty-gift-certificate__block{if $runtime.mode == "add" || $gift_cert_data.send_via == "E"} hidden{/if}" id="post_block">
        ...
        <div class="ty-control-group zipcode">
            ...
            <input type="text" id="gift_cert_zipcode" name="gift_cert_data[zipcode]" class="ty-input-text-short" size="50" value="{$gift_cert_data.zipcode}" />
        </div>
