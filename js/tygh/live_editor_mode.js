(function(_, $) {
    ...
    $(function(){
        $.loadCss(['js/lib/x-editable/jqueryui-editable/css/jqueryui-editable.css']);
        $.getScript('js/lib/x-editable/jqueryui-editable/js/jqueryui-editable.js', function(data, textStatus, jqxhr){
    ...
    var methods = {
                    ...
                    if (!t_elm.data('editable')) {
                        ...
                        if (object_name && rule) {
                            if (live_editor_obj.input_type) {
                                type = live_editor_obj.input_type;
                            } else if (rule['input_type_fields'] && rule['input_type_fields'][object_field]) {
                                type = rule['input_type_fields'][object_field];
                        ...
                        if (type == 'input') {
                            ...
                            params.tpl = '<textarea cols="70" class="cm-wysiwyg"></textarea>';
                        } else if (type == 'price') {
        ...
        load: function(content) {
            ...
            $('[data-ca-live-editor-obj]', content).each(function() {
                ...
                elm
                    ...
                    .before('<i class="cm-icon-live-edit icon-live-edit ty-icon-live-edit"></i>')
        ...
        cancel: function() {
            if (live_editor_obj) {
                methods.set(live_editor_obj.old_phrase);
                live_editor_obj = null;
            }
        }
