...
<table class="ty-table">
    <tr>
        ...
        <th style="width: 5%" class="ty-center">{__("quantity")}</th>
        <th style="width: 7%" class="ty-center">{__("subtotal")}</th>
    </tr>
    ...
    <tr>
        ...
        <td class="ty-right"><strong>{if $product.extra.exclude_from_calculate}{__("free")}{else}{include file="common/price.tpl" value=$product.subtotal}{/if}</strong></td>
    </tr>
    {/foreach}
</table>
{/if}