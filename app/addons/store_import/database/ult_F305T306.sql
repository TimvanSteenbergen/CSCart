...
UPDATE `?:ult_language_values` SET value='Machinable (First-Class Mail or Standard Post)' WHERE name='ship_usps_machinable';
UPDATE `?:language_values` SET value='USPS Tracking/Delivery confirmation' WHERE name='usps_service_delivery_confirmation';
UPDATE `?:ult_language_values` SET value='USPS Tracking/Delivery confirmation' WHERE name='usps_service_delivery_confirmation';
...
DELETE FROM `?:ult_language_values` WHERE name='usps_service_restricted_delivery';
