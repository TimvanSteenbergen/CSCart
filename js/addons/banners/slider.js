    ...
    $.fn.bannerSlider = function(params){
        ...
        loadSlider = function(obj) {
            ...
            if (slider.navigation == 'D' || slider.navigation == 'P') {
                ...
                var btn_prev = $('<div class="cm-slide-prev"><i class="icon-left-open-thin"></i></div>').appendTo(obj);
                ...
                var btn_next = $('<div class="cm-slide-next"><i class="icon-right-open-thin"></i></div>').appendTo(obj);
