    ...
    <div class="simple-list product-container clearfix">
        ...
        {$smarty.capture.$form_open nofilter}
            ...
            {if $show_features || $show_descr}
                <div class="simple-list__feature">{assign var="product_features" value="product_features_`$obj_id`"}{$smarty.capture.$product_features nofilter}</div>
                <div class="simple-list__descr">{assign var="prod_descr" value="prod_descr_`$obj_id`"}{$smarty.capture.$prod_descr nofilter}</div>
            {/if}
