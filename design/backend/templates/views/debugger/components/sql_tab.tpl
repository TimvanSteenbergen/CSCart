        ...
        <table class="deb-table">
            ...
            {foreach from=$data.count item="query"}
                ...
                <tr>
                    ...
                    <td width="60px"><strong>{$query.count}</strong></td>
                    <td width="60px"><strong>{$query.min_time|number_format:"5"}</strong></td>
                    <td width="60px"><strong>{$query.max_time|number_format:"5"}</strong></td>
                    <td width="120px"><strong>{$average_time|number_format:"5"}</strong></td>
                </tr>
    ...
    <div class="deb-sub-tab-content" id="DebugToolbarSubTabSQLParse">
        <form action="admin.php" method="post" class="cm-ajax" id="DebugToolbarSqlParce">
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="100px">{include file="buttons/button.tpl" but_text="Send" but_id="DebugToolbarSubTabSQLParseSubmit" but_meta="btn-primary"}</td>
                    <td valign="middle">
