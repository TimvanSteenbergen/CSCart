...
$section_id = db_query("INSERT INTO ?:settings_sections (`parent_id`, `edition_type`, `name`, `position`, `type`) VALUES ('0', 'ROOT,ULT:VENDOR', 'product_configurator', '0', 'ADDON')");
...
. "('ROOT,ULT:VENDOR', 'thumbnails_width', $section_id, $tab_section_id, 'I', '120', 0, 'N', '')"
);
db_query("INSERT INTO ?:settings_descriptions (`object_id`, `object_type`, `lang_code`, `value`, `tooltip`) VALUES "
. "($object_id, 'O', 'EN', 'Thumbnails width', '')"
);
